...
const char* D3D12Utils::FeatureLevelToString(const D3D_FEATURE_LEVEL FeatureLevel)
{
	switch (FeatureLevel)
	{
...
const char* D3D12Utils::ShaderModelToString(const D3D_SHADER_MODEL ShaderModel)
{
	switch (ShaderModel)
	{
...
const char* D3D12Utils::ShaderModelToMajorString(const D3D_SHADER_MODEL ShaderModel)
{
	switch (ShaderModel)
	{
	case D3D_SHADER_MODEL_5_1: return "SM5";
...
const char* D3D12Utils::DXGIFormatToString(const DXGI_FORMAT Format)
{
	switch (Format)
	{
	...
	case DXGI_FORMAT_SAMPLER_FEEDBACK_MIP_REGION_USED_OPAQUE: return
